...
p <- dotplot(GO_terms, showCategory = 10, orderBy = "p.adjust")
...
p <- dotplot(GO_terms_age, showCategory = 10, orderBy = "p.adjust")
...
dotplot(GO_terms_gender, showCategory = 10)

```

Im changing p value for 0.05 for wider range of data
...
p <- dotplot(GO_terms_gender_2, showCategory = 10)
